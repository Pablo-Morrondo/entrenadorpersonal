(() => {
  ...
  const manualType=document.querySelector('[data-v32="trainingType"]');
  manualType?.querySelector('[data-v="Otro"]')?.classList.add('on');
  if(manualType)manualType.parentElement.style.setProperty('display','none','important');
